...
export const esES: LocalizationResource = {
  ...
  formFieldLabel__organizationName: 'Nombre de la Comunidad',
  formFieldLabel__role: 'Rol',
  formFieldLabel__confirmDeletion: 'Confirmar',
  ...
  membershipRole__basicMember: 'Integrante',
  ...
  signUp: {
    ...
    emailCode: {
      title: 'Verifica stu correo electrónico',
      subtitle: 'para continuar a {{applicationName}}',
      formTitle: 'Código de verificación',
      formSubtitle: 'Introduce el código de verificación enviado a tu correo electrónico',
    ...
    phoneCode: {
      ...
      subtitle: 'para continuar a {{applicationName}}',
      formTitle: 'Código de verificación',
      formSubtitle: 'Introduce el código de verificación enviado a tu número de teléfono',
      resendButton: 'Re-enviar código',
    },
    continue: {
      title: 'Rellena los campos que faltan',
      subtitle: 'para continuar a {{applicationName}}',
      actionText: '¿Tienes una cuenta?',
      actionLink: 'Entrar',
    },
  ...
  signIn: {
    ...
    emailCode: {
      ...
      subtitle: 'para continuar a {{applicationName}}',
      formTitle: 'Código de verificación',
      formSubtitle: 'Introduce el código de verificación enviado a tu correo eléctronico',
      resendButton: 'Re-enviar código',
    },
    emailLink: {
      title: 'Revisa su correo electrónico',
      subtitle: 'para continuar a {{applicationName}}',
      formTitle: 'Enlace de verificación',
    ...
    alternativeMethods: {
      ...
      getHelp: {
        ...
        content: `Si tienes dificultades para iniciar sesión en tu cuenta, envíanos un correo electrónico y trabajaremos para restablecer el acceso lo antes posible.`,
  ...
  userProfile: {
    ...
    start: {
      ...
      dangerSection: {
        ...
        deleteAccountDescription: 'Eliminar tu cuenta y toda su información',
      },
    },
    profilePage: {
  ...
  organizationSwitcher: {
    ...
    notSelected: 'Ninguna comunidad seleccionada',
    action__createOrganization: 'Crear Comunidad',
    action__manageOrganization: 'Administrar Comunidad',
  },
  impersonationFab: {
  ...
  organizationProfile: {
    start: {
      headerTitle__members: 'Integrantes',
      headerTitle__settings: 'Configuración',
      headerSubtitle__members: 'Ver y administrar los integrantes de la comunidad',
      headerSubtitle__settings: 'Administrar la configuración de la comunidad',
    },
    profilePage: {
      title: 'Perfil de la comunidad',
      subtitle: 'Administrar el perfil de la comunidad',
      successMessage: 'La comunidad ha sido actualizada.',
      dangerSection: {
        title: 'Peligro',
        leaveOrganization: {
          title: 'Abandonar la comunidad',
          messageLine1:
            '¿Está seguro de que desea abandonar esta comunidad? Perderá el acceso a esta comunidad y sus aplicaciones.',
          messageLine2: 'Esta acción es permanente e irreversible.',
          successMessage: 'Has dejado la comunidad.',
          actionDescription: 'Escribe {{organizationName}} para continuar.',
        },
        deleteOrganization: {
          title: 'Eliminar comunidad',
          messageLine1: '¿Está seguro de que desea eliminar esta comunidad?',
          messageLine2: 'Esta acción es permanente e irreversible',
          actionDescription: 'Escriba {{organizationName}} a continuación para continuar',
          successMessage: 'Ha eliminado la comunidad',
        },
      },
    },
    invitePage: {
      title: 'Invitar integrantes',
      subtitle: 'Invitar nuevos integrantes a esta comunidad',
    ...
    membersPage: {
      detailsTitle__emptyRow: 'No hay integrantes para mostrar',
      ...
      activeMembersTab: {
        ...
        menuAction__remove: 'Quitar integrante',
      },
      invitedMembersTab: {
      ...
      invitationsTab: {
        table__emptyRow: 'No hay invitaciones',
        manualInvitations: {
          headerTitle: 'Invitaciones individuales',
          headerSubtitle: 'Invitar nuevos integrantes y gestionar las invitaciones existentes',
        },
        autoInvitations: {
          headerTitle: 'Invitaciones automáticas',
          headerSubtitle:
            'Invita a usuarios conectando un dominio de correo electrónico con tu comunidad. Cualquiera que se registre con un dominio de correo electrónico coincidente podrá unirse a la comunidad en cualquier momento',
      ...
      requestsTab: {
        ...
        requests: {
          ...
          headerSubtitle: 'Examinar y gestionar los usuarios que han solicitado unirse a la comunidad',
        },
        autoSuggestions: {
          headerTitle: 'Sugerencias automáticas',
          headerSubtitle:
            'Los usuarios que se registren con un dominio de correo electrónico coincidente, podrán ver una sugerencia para solicitar unirse a tu comunidad',
          primaryButton: 'Gestionar dominios verificados',
        },
      },
    },
  ...
  createOrganization: {
    ...
    formButtonSubmit: 'Crear comunidad',
    subtitle: 'Establecer el perfil de la comunidad',
    invitePage: {
  ...
  unstable__errors: {
    ...
    form_password_pwned: 'Esta contraseña ha sido encontrada como parte de una brecha y no puede ser utilizada, por favor inténtalo con otra contraseña',
    ...
    passwordComplexity: {
      ...
      requireSpecialCharacter: 'un caracter especial',
    },
    zxcvbn: {
